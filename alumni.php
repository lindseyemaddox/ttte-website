...
<section id="mast">
	...
	<img src="/_assets/img/header-alumni.jpg" alt="vintage Tennessee Tech Tuba Ensemble photo" title="vintage Tennessee Tech Tuba Ensemble photo">

</section><!--mast-->

<section id="main" class="alumni">

	<div class="inner">
	
		<h1>The Tennessee Tech Tuba Ensemble Alumni</h1>
    	...
    	<div id="slider-cont">
      		...
      		<div id="options" class="clearfix">
        		...
        		<ul id="filters" class="option-set clearfix" data-option-key="filter">
          			<li><a href="#filter" data-option-value=".y1967">1967</a></li>
          			<li><a href="#filter" data-option-value=".y1968">1968</a></li>
          			<li><a href="#filter" data-option-value=".y1969">1969</a></li>
          			<li><a href="#filter" data-option-value=".y1970">1970</a></li>
          			<li><a href="#filter" data-option-value=".y1971">1971</a></li>
          			<li><a href="#filter" data-option-value=".y1972">1972</a></li>
          			<li><a href="#filter" data-option-value=".y1973">1973</a></li>
          			<li><a href="#filter" data-option-value=".y1974">1974</a></li>
  			    	...
  			    	<aside class="sorter">
        			    	...
        			    	<div id="members" class="clearfix">
        						...
        						<article class="member <?= $member['instrument']; ?> <?= $member['years-y']; ?> <?= $member['sorters']; ?>">
        						  ...
        						  <a href="/profile/<?= $member['name-first'].'-'.$member['name-last'].'.php'?>;" class="btn fancybox fancybox.iframe <?= (!$member['bio-date']) ? 'na': null; ?>">View Profile</a>
        						</article>
        						<?php
        						  } //endwhile
        						?>
