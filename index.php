...
<section class="slider">
	<div class="flexslider carousel">
		<ul class="slides">
			...
			<li>
				<div class="headline">
					<p class="number" id="carnegie">8</p>
			...
			<li>
				<div class="headline">
					<p class="number" id="recordings">15</p>
			...
			<li>
				<div class="headline">
					<p class="number" id="commissioned">18</p>
			...
			<li>
				<div class="headline">
					<p class="number" id="current">26</p>
			...
			<li>
				<div class="headline">
					<p class="number" id="professional">82</p>
...
<script>
	$(document).ready(function(){
		...
		$('#carnegie').each(function () {
		  var $this = $(this);
		  jQuery({ Counter: 0 }).delay( 7000 ).animate({ Counter: $this.text() }, {
		    duration: 1000,
		    easing: 'swing',
		    step: function () {
		      $this.text(Math.ceil(this.Counter));
		...
		$('#recordings').each(function () {
		  var $this = $(this);
		  jQuery({ Counter: 0 }).delay( 14000 ).animate({ Counter: $this.text() }, {
		    duration: 1000,
		    easing: 'swing',
		    step: function () {
		      $this.text(Math.ceil(this.Counter));
		...
		$('#commissioned').each(function () {
		  var $this = $(this);
		  jQuery({ Counter: 0 }).delay( 21000 ).animate({ Counter: $this.text() }, {
		    duration: 1000,
		    easing: 'swing',
		    step: function () {
		      $this.text(Math.ceil(this.Counter));
		...
		$('#current').each(function () {
		  var $this = $(this);
		  jQuery({ Counter: 0 }).delay( 28000 ).animate({ Counter: $this.text() }, {
		    duration: 1000,
		    easing: 'swing',
		    step: function () {
		      $this.text(Math.ceil(this.Counter));
		...
		$('#years').each(function () {
		  var $this = $(this);
		  jQuery({ Counter: 0 }).delay( 35000 ).animate({ Counter: $this.text() }, {
		    duration: 1000,
		    easing: 'swing',
		    step: function () {
		      $this.text(Math.ceil(this.Counter));
		...
		$('#professional').each(function () {
		  var $this = $(this);
		  jQuery({ Counter: 0 }).delay( 42000 ).animate({ Counter: $this.text() }, {
		    duration: 1000,
		    easing: 'swing',
		    step: function () {
		      $this.text(Math.ceil(this.Counter));
		...
		$('#alumni').each(function () {
		  var $this = $(this);
		  jQuery({ Counter: 0 }).delay( 49000 ).animate({ Counter: $this.text() }, {
		    duration: 2000,
		    easing: 'swing',
		    step: function () {
		      $this.text(Math.ceil(this.Counter));
